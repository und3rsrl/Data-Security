...
char fourSquare[10][10],c[1000],ans[1000],decy[1000];;
...
void encrypt(int l)
{
    ...
    for(i=0;i<l;i=i+2)
    {
        ...
        bx = f.x;
        by = f.y;
        ans[i] = fourSquare[ax][by];
        ans[i+1] = fourSquare[bx][ay];
        cout<<ans[i]<<ans[i+1];
    }
}
...
void decrypt(int l)
{
    ...
    for(i=0;i<l;i=i+2)
    {
        ...
        bx = f.x;
        by = f.y;
        decy[i] = fourSquare[ax][by];
        decy[i+1] = fourSquare[bx][ay];
